    ...
    addTeamMember: requiresAuth.createResolver(
      async (parent, { email, teamId }, { models, user }) => {
        try {
          ...
          console.log(team.dataValues.owner, userToAdd.dataValues.id);
          console.log(user);
          if (team.dataValues.owner !== user.id) {
            return {
              ok: false,
              errors: [
                {
          ...
          await models.Member.create({ user_id: userToAdd.dataValues.id, teamId });
